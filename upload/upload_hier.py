# -*- coding: utf-8 -*-
"""계층형 청킹 결과 → OpenAI 임베딩 → Supabase docs_hier_v2 업로드"""
import json
...
EMBED_MODEL = "openai/text-embedding-3-small"   # 1536차원
TABLE_NAME  = "docs_hier_v2"
INPUT_PATH  = "../chunking/hierarchical_chunks.json"
BATCH_SIZE  = 20
...
for start in range(0, len(records), BATCH_SIZE):
    ...
    # 임베딩 입력: source_path + 본문 결합
    texts = [f"{r['source_path']}\n{r['content']}" for r in batch]
